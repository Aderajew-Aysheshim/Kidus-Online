...
export const translations = {
  ...
  am: {
    ...
    heroTitle: 'እውነተኛ ኢትዮጵያዊ መሳሪያዎችን ይማሩ እና ይይዙ',
    heroDesc: 'ክራር እና በገናን - ከመቶ ሐYear ዓመታት ባህላዊ ሂሳብ ያላቸው መሳሪያዎችን ይወቅሙ። ከተለያዩ ሙዚቀኞች ይማሩ እና ሙሉ ዓለም ሊደርሳችሁ በሚችሉ የእጅ-ሰሪ ክፍሎች ይይዙ።',
